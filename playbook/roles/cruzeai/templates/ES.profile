...
export PROJECT_PATH=/home/spclink/cruzlink
export grppath=$PROJECT_PATH/online

export JAVA_HOME=/usr/java/latest
export PATH=.:$JAVA_HOME/bin:/usr/local/bin:/usr/sbin:/usr/bin:/bin:/opt/freeware/sbin
...
##### Root Setting ######
export SOL_TYPE=EAI
export SERVER_TYPE=EAI
export CRUZ_ROOT=/sw/cruzeai/cruzlink
export CRUZ_LOGDIR=/logs/cruzeai/
#################################
if [ ! -d "$CRUZ_LOGDIR" ];
then
        mkdir -p $CRUZ_LOGDIR
...
#################################
export CRUZ_BATDIR=/sw/cruzeai/files
...
##### MQ Setting ######
export CRUZ_MQ_BROKERURL=tcp://{{ ansible_eth0["ipv4"]["address"] }}:19093
export MGR_PORT=19094
export MGR_IP={{ ansible_eth0["ipv4"]["address"] }}
export ACTIVEMQ_HOME=$CRUZ_ROOT/cruzMQ

##### Invoke transform Setting ######
export invokeRcvPort=19095
export downloaderRcvPort=19092

##### MGT process Setting ######
export rcvPort=19096
export sendPort=19097
export jmxPort=19098

##### Monitoring Setting ######
export nodePortForMonitoring=19100

##### SIMUL Setting #####
export SIMUL_PORT=19099

##### MT Setting #####
export MT_IP={{ ansible_eth0["ipv4"]["address"] }}
export MT_PORT=19101

#### WSS Setting ####
export WSS_IP={{ ansible_eth0["ipv4"]["address"] }}
export WSS_PORT=19082

##### iManager Setting ######
export MANAGER_PORT=19080
export DB_USERNAME={{DB_USERNAME}}
export DB_PASSWORD={{DB_PASSWORD}}

##### FTS Setting #####
export FTS_PORT=19110



##### SESSION INFO Setting ######
export SESSION_PORT=19087
